...
class _$ReviewsRecordSerializer implements StructuredSerializer<ReviewsRecord> {
  ...
  ReviewsRecord deserialize(
    ...
    while (iterator.moveNext()) {
      ...
      switch (key) {
        case 'podcastRef':
          result.podcastRef = serializers.deserialize(value,
...
class _$ReviewsRecord extends ReviewsRecord {
  @override
  final DocumentReference<Object?>? podcastRef;
  @override
  ...
  int get hashCode {
    return $jf($jc(
        $jc(
            $jc(
                $jc($jc($jc(0, podcastRef.hashCode), userRef.hashCode),
                    rating.hashCode),
...
class ReviewsRecordBuilder
  ...
  DocumentReference<Object?>? _podcastRef;
  DocumentReference<Object?>? get podcastRef => _$this._podcastRef;
  set podcastRef(DocumentReference<Object?>? podcastRef) =>
      _$this._podcastRef = podcastRef;
